...
input_folder = 'ProcessedCFashionBeauty'  # Relative path from the current working directory
output_folder = 'GraphsProcessedCFashionBeauty'  # Relative path from the current working directory
